...
File(config['output_path']+'T'+'.pvd') << model.T
File(config['output_path']+'Mb'+'.pvd') << model.Mb
File(config['output_path']+'T'+'.xml') << model.T
File(config['output_path']+'u'+'.xml') << model.u
File(config['output_path']+'v'+'.xml') << model.v
File(config['output_path']+'w'+'.xml') << model.w
File(config['output_path']+'Mb'+'.xml') << model.Mb
