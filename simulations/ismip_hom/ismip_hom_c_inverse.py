...
srfmodel.init_u_mag(srfmodel.u)
...
plot_variable(u = srfmodel.u, name = 'U_true', direc = plt_dir,
...
def adj_post_cb_ftn():
	...
	#U_max  = srfmodel.u_mag.vector().max()
	#U_lvls = array([U_min, 170, 180, 200, 220, 240, 260, 280,  U_max])
	plot_variable(u = srfmodel.u, name = 'U_opt', direc = plt_dir,
...
#mom.form_obj_ftn(u        = mom.get_unknown(),
...
# optimize for beta :
mom.optimize(u                 = mom.get_unknown(),
             u_ob              = [model.u_ob, model.v_ob],
             I                 = I,
             control           = model.beta,
             J_measure         = J_measure,
